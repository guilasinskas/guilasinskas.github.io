...
<template>
    <transition name="fade" mode="in-out">
        <Toast v-if="showToast" :message="'Obrigado pela mensagem! Entrarei em contato!'" @close="handleClose"/>
    </transition>
        ...
        <div class="container px-3 mx-auto max-w-6xl 2xl:max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 dark:text-slate-300 tracking-wide">
                <div class="md:col-span-5">
                    <h3 class="font-medium text-3xl mb-2 dark:text-white">Minhas redes sociais</h3>
                    <p class="text-lg text-slate-600 dark:text-slate-300">Não gosta de forms? Envie mensagem no Linkedin! <a href="https://www.linkedin.com/in/guilasinskas/" target="_blank" class="font-medium text-secondary-500 hover:text-secondary-600 dark:text-secondary-300 dark:hover:text-secondary-400 transition-all duration-300">clique aqui!</a></p>
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p><a href="mailto:guilherme.lasinskas@gmail.com" class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">guilherme.lasinskas@gmail.com</a></p>
                            </div>
                        </li>
                        <li class="flex items-center space-x-4">
                            <div>
                            ...
                            <div>
                                ...
                                <ul class="flex items-center space-x-2">
                                    <li>
                                        <a href="https://www.linkedin.com/in/guilasinskas/" target="_blank">
                        ...
                        <li class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p><a href="https://www.google.com/maps/place/São+Paulo,+SP/@-23.6805339,-47.2191439,10z/" target="_blank" class="transition-all duration-300 hover:text-secondary-500 dark:hover:text-secondary-300">São Paulo, SP</a></p>
                            </div>
                        </li>
                    </ul>
                </div>
