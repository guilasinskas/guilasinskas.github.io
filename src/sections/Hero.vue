...
onMounted(() => {
    typed = new Typed(typedElement.value, {
        strings: ["Business Analyst", "Tech-Savvy"],
        typeSpeed: 50,
        backSpeed: 30,
        backDelay: 5000,
        loop: true,
...
<template>
    ...
    <section id="home" class="relative min-h-[calc(100vh-85px)] overflow-x-clip bg-slate-100 dark:bg-[#0B1120]">
        ...
        <div class="container mx-auto px-3 flex flex-col justify-center items-center min-h-[calc(100vh-85px)] max-w-6xl 2xl:max-w-7xl">
            ...
            >
                <span class="bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-purple-500 dark:from-sky-400 dark:to-teal-400">Guilherme Lasinskas</span>
            </h1>
            <h2
                v-motion
                :initial="{
            ...
            >
                <a href="https://github.com/guilasinskas" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/github.png" alt="Github" />
                ...
                <a href="https://www.linkedin.com/in/guilasinskas" target="_blank" class="group flex items-center space-x-3">
                    <img class="w-[1.5rem] md:w-[1.7rem]" src="/images/linkedin.png" alt="Linkedin" />
            ...
            >
                <LinkButton link="#about" class="text-sm md:text-xl px-5 py-3 md:px-7 md:py-4"> Sobre mim </LinkButton>
                <LinkButton btn-type="filled" link="#works" class="text-sm md:text-xl px-5 py-3 md:px-7 md:py-4">
                    <span>O que já fiz?</span>
                    <template #icon>
